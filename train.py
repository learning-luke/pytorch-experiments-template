...
######################################################################################################### Data
trainloader, testloader, trainset, testset, in_shape = load_dataset(dataset=args.dataset, data_loc=args.root, batch_size=args.batch_size, num_dataloading_workers=args.num_dataloading_workers, download=True)
