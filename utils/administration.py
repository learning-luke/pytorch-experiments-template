...
def parse_args():
    ...
    parser.add_argument(
        "-root", "--root", type=str, default="../data", help="Which dataset to use"
    )
    parser.add_argument(
        "-norm",
        "--dataset_norm_type",
    ...
    parser.add_argument(
        "-batch", "--batch_size", type=int, default=128, help="Batch Size"
    )
    parser.add_argument(
        "-tbatch", "--test_batch_size", type=int, default=100, help="Test Batch Size"
    )
    parser.add_argument(
        "-x",
        "--max_epochs",
    ...
    parser.add_argument(
        "-resume", "--resume", type=int, default=0, help="Resume training?"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-str", "--strides", type=int, nargs="+", default=[2, 2, 2, 2], help="Strides"
    )
    parser.add_argument(
        "-ker",
        "--kernel_sizes",
    ...
    # optimization
    parser.add_argument(
        "-l", "--learning_rate", type=float, default=0.1, help="Base learning rate"
    )
    parser.add_argument(
        "-sched",
        "--scheduler",
    ...
    parser.add_argument(
        "-wd", "--weight_decay", type=float, default=5e-4, help="Weight decay value"
    )
    parser.add_argument(
